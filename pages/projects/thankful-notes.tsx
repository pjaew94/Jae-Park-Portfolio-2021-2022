...
const ThankfulNotesProject = () => {

  const proj = projectInfoList[0]
  ...
  return (
    <div className="flex flex-col">
      ...
      />
      <ProjectFooter 
        proj1Name="JLC Serves"
        proj1Href="/projects/jlc-serves"
        proj1date="04.06.2021"
...
export default ThankfulNotesProject;
